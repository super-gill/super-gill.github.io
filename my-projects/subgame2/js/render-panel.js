...
(() => {
  ...
  function drawStartScreen(W,H){
    ...
    ctx.font=`bold ${U(52)}px ui-monospace,monospace`;
    ctx.fillText('STEADY BUBBLE',W/2, H*0.14);
    ctx.fillStyle='rgba(100,160,220,0.50)';
    ctx.font=`${U(12)}px ui-monospace,monospace`;
    ctx.letterSpacing='4px';
    ctx.fillText('COLD WAR SUBMARINE TACTICS  ▸  CHOOSE SCENARIO', W/2, H*0.14+U(26));
    ...
    ctx.font=`bold ${U(17)}px ui-monospace,monospace`;
    ctx.textAlign='center';
