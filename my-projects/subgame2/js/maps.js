(() => {
  ...
  const coastalMap = {
    ...
    seaColour: "#daeaf7",
    // Land areas (filled polygons)
    land: [],
    // Player and enemy spawn zones (avoid land)
    playerSpawn: {wx:4000, wy:5000},
    enemySpawnBias: {cx:6000, cy:7000}, // enemy spawns biased around here
  };
  ...
  function setMap(name){ activeMap = maps[name] || coastalMap; }
  function getMap(){ return activeMap; }
  ...
  function snapToSea(wx,wy,step=80){
  ...
  window.MAPS={getMap,setMap,isLand,snapToSea};
})();
