...
function log(cat, text, priority=P.NORMAL)  { addLog(cat, text, priority); }
function qlog(cat, text, delay, priority=P.NORMAL) { queueLog(cat, text, delay, priority); }
function msg(text, t=1.2)                   { setMsg(text, t); }
