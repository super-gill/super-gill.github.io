  ...
  window.drawFrame = ()=>{
    ...
    const drawWorld = (offsetX)=>{
      ...
      for(const e of enemies){
        ...
        const ey = e.y - cam.y;
        const close = Math.hypot(wrapDx(player.x, e.x), e.y-player.y) < 520;
        const show = (e.seen>0) || close;
        ctx.strokeStyle = show ? "#111827" : "rgba(17,24,39,0.16)";
        ...
        if(show && e.suspicion>0.65){
          ctx.fillStyle = "#111827";
          doodleText("!", ex, ey - e.r - 36, 18*DPR, "center");
        }
