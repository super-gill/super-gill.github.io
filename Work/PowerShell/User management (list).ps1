...
#remove a license
Set-MsolUserLicense -UserPrincipalName "jess@gaianet.org" -removeLicenses "gaiafoundation:O365_BUSINESS_ESSENTIALS"
...
Remove-MsolUser -UserPrincipalName "davidchew@contoso.com" -RemoveFromRecycleBin -Force